...
function getAISDKLanguageModel(subProvider: string, subModelName: string, apiKey?: string) {
  if (apiKey) {
...
export class LLMProvider {
  ...
  getClient(modelName: AvailableModel, clientOptions?: ClientOptions): LLMClient {
    if (modelName.includes('/')) {
      ...
      const languageModel = getAISDKLanguageModel(subProvider, subModelName, clientOptions?.apiKey);
